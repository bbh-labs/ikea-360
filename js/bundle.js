...
/***/ function(module, exports, __webpack_require__) {
	...
	App.Viewer.Overlay = React.createClass({
		...
		render: function render() {
			return React.createElement(
				'div',
				{ id: 'overlay', ref: 'overlay', className: 'flex' },
				React.createElement(App.Viewer.Topbar, { room: this.props.room }),
				React.createElement(App.Viewer.Bottombar, { room: this.props.room }),
	...
	App.Viewer.Topbar = React.createClass({
		...
		render: function render() {
			return React.createElement(
				'div',
				{ id: 'topbar' },
				React.createElement('img', { className: 'logo', src: 'images/ikea360_logo.png', alt: 'ikea logo', onClick: this.backToHome }),
	...
	App.Viewer.Bottombar = React.createClass({
		displayName: 'Bottombar',

		render: function render() {
			return React.createElement(
				'div',
				{ id: 'bottombar', className: 'flex row align-start justify-end' },
				React.createElement('img', { className: 'map', src: 'images/maps/' + rooms[this.props.room] + '.png', alt: 'ikea logo' })
			);
		}
	});
